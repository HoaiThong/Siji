...
public class AdvertiseUtils {
    ...
    public Advertise createFromJSONObject(JSONObject jsonObject) {
        ...
        try {
            ...
            if (!jsonObject.isNull(TAG_TITLE)) a.setTitle(jsonObject.getString(TAG_TITLE));
            if (!jsonObject.isNull(TAG_MIME_TYPE)) a.setMimeType(jsonObject.getString(TAG_MIME_TYPE));
